...
class ExpiredVrnRejoinSpec extends BaseSpec {
  ...
  Feature("Expired VRN Rejoin journeys") {
    Scenario("A trader who has left the service with outstanding returns and now has an expired VRN") {
      ...
      Then("the user is shown the correct banner for an expired VRN trader who has left the service and has outstanding returns")
    ...
    Scenario("A trader who has left the service with no outstanding returns and now has an expired VRN") {
      ...
      Then("the user is shown the correct banner for an expired VRN trader who has left the service and has no outstanding returns")
    ...
    Scenario("A trader who has been removed from the service with outstanding returns and now has an expired VRN") {
      ...
      Then("the user is shown the correct banner for an expired VRN trader who has been removed from the service and has outstanding returns")
    ...
    Scenario("A trader who has been removed from the service with no outstanding returns and now has an expired VRN") {
      ...
      Then("the user is shown the correct banner for an expired VRN trader who has been removed from the service and has no outstanding returns")
